...
/**
 * copied from Monolog\Handler\SocketHandler to add port to connection
 */
class TcpFluentHandler extends AbstractProcessingHandler
{
    /** @var string */
    ...
    {
        return @pfsockopen($this->connectionString, 5170, $this->errno, $this->errstr, $this->connectionTimeout);
    }
    ...
    {
        return @fsockopen($this->connectionString, 5170, $this->errno, $this->errstr, $this->connectionTimeout);
    }
