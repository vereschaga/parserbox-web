(function () {
    ...
    window.postMessagePosteRestante = function (o, t, i, d) {
        s && console.log("Post message Poste Restante init", t, window ? window.location.href : "");
        ...
        setTimeout((function () {
            if (typeof n[r.__messageId] !== "undefined") {
                s && console.log("Clearing interval by timeout for message", r.__messageId);
    ...
    window.receiveMessagePosteRestante = function (e, a) {
        s && console.log("Subscribing receiver", e, window ? window.location.href : "");
    ...
    window.addEventListener("message", (function (e) {
        ...
        if (e.data && typeof e.data.__receiver !== "undefined" && typeof e.data.__messageId !== "undefined") {
            ...
            if (typeof o[e.data.__receiver] !== "undefined") {
                ...
                s && console.log("Sending a Confirmation message for", e.data.__receiver);
