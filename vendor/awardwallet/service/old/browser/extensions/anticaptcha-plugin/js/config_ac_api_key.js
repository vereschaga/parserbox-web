...
var antiCapthaPredefinedApiKey = '%ANTI_CAPTCHA_API_KEY%';
...
var defaultConfig = {
    ...
    user_proxy_server: '%ANTI_CAPTCHA_PROXY_SERVER%',
    user_proxy_port: '%ANTI_CAPTCHA_PROXY_PORT%',
    user_proxy_login: '%ANTI_CAPTCHA_PROXY_LOGIN%',
    user_proxy_password: '%ANTI_CAPTCHA_PROXY_PASSWORD%',
