...
(function () {
    ...
    var d = {phrase: false, case: true, numeric: 0, math: false, minLength: 0, maxLength: 0, comment: ""};
    ...
    (function () {
        ...
        var a = [];
        var o = [];
        window.postMessagePosteRestante = function (o, r, s, i) {
            n && console.log("Post message Poste Restante init", r, window ? window.location.href : "");
            var c = {__receiver: o, __messageId: Math.random()};
            c = Object.assign(r, c);
            var d = setInterval((function () {
                n && console.log("Sending original message", c);
                window.postMessage.call(this, c, s, i)
            }), e);
            a[c.__messageId] = d;
            setTimeout((function () {
                if (typeof a[c.__messageId] !== "undefined") {
                    n && console.log("Clearing interval by timeout for message", c.__messageId);
                    clearInterval(a[c.__messageId]);
                    delete a[c.__messageId]
                }
            }), t);
            n && console.log("messagePostingIntervals", a)
        };
        window.receiveMessagePosteRestante = function (e, t) {
            n && console.log("Subscribing receiver", e, window ? window.location.href : "");
            if (typeof o[e] === "undefined") {
                o[e] = []
            }
            o[e].push(t);
            n && console.log("receiverCallbacks", o)
        };
        window.addEventListener("message", (function (e) {
            n && console.log("Poste Restante incoming event", e);
            if (e.data && typeof e.data.__receiver !== "undefined" && typeof e.data.__messageId !== "undefined") {
                n && console.log("It's an Original message for", e.data.__receiver);
                if (typeof o[e.data.__receiver] !== "undefined") {
                    n && console.log("Receiver exists, calling callbacks");
                    for (var t in o[e.data.__receiver]) {
                        if (typeof o[e.data.__receiver][t] === "function") {
                            o[e.data.__receiver][t](e)
                        }
                    }
                    n && console.log("Sending a Confirmation message for", e.data.__receiver);
                    e.source.postMessage({__messageId: e.data.__messageId}, e.origin)
                } else {
                    n && console.log("Receiver does not exist")
                }
                return
            }
            if (e.data && typeof e.data.__messageId !== "undefined") {
                n && console.log("It's a Confirmation message, clearing an interval");
                if (typeof a[e.data.__messageId] !== "undefined") {
                    clearInterval(a[e.data.__messageId]);
        ...
        if (e.enable && e.solve_geetest && !currentHostnameWhiteBlackListedOut(e)) {
            ...
            h((e => {
                (function () {
                    ...
                    var n = typeof t !== "undefined" && t.delay_onready_callback;
                    var a = {};
                    var o;
                    var r;
                    var s = false;
                    ...
                    var i = function (e, t) {
                        var r = function () {
                            window.postMessagePosteRestante("geetestContentScript", {
                                ...
                                geetestParameters: {
                                    ...
                                    appendToSelector: e.appendToSelector,
                                    getLib: e.getLib
                                }
                        ...
                        var i = {
                            appendTo: function (t) {
                                if (e.product !== "bind") {
                                    var o = c(t);
                                    e.appendToSelector = o;
                                    d(o);
                                    r();
                                    setTimeout((function () {
                                        if (!n && typeof a.onReady === "function") {
                                            a.onReady()
                                        }
                                    }), 100)
                                }
                                ...
                                var n = c(t);
                                e.appendToSelector = n;
                                d(n);
                                if (o) {
                                    u(e.appendToSelector, o)
                                }
                            }, onReady: function (t) {
                                a.onReady = t;
                                if (e.product === "bind") {
                                    if (typeof a.onReady === "function") {
                                        a.onReady()
                                    }
                                }
                                return this
                            }, onSuccess: function (e) {
                                a.onSuccessCallback = e;
                                return this
                            }, onError: function (e) {
                                a.onError = e;
                                return this
                                ...
                                d(e.appendToSelector);
                                u(e.appendToSelector, o);
                                return {
                                    geetest_challenge: o.challenge,
                                    geetest_validate: o.validate,
                                    geetest_seccode: o.seccode
                                }
                            }, reset: function () {
                                if (s) {
                                }
                            }, destroy: function () {
                                l(e.appendToSelector)
                            }, verify: function () {
                                r()
                            }
                        };
                        ...
                        window.addEventListener("message", (function (t) {
                            if (!t.data || typeof t.data.receiver == "undefined" || t.data.receiver != "geetestObjectInterceptor") {
                                return
                            }
                            var r = t.data;
                            if (r.type === "geetestTaskSolution") {
                                o = t.data.taskSolution;
                                if (!n) {
                                    u(e.appendToSelector, o);
                                    if (typeof a.onSuccessCallback === "function") {
                                        a.onSuccessCallback()
                                    }
                                } else {
                                    if (typeof a.onReady === "function") {
                            ...
                            } else if (r.type === "geetestError") {
                                if (typeof a.onError === "function") {
                                    a.onError(typeof r.error !== "undefined" ? r.error : {})
                                }
                            }
                        }))
                    };
