    ...
    if (e) {
        window[e] = function () {
            ...
            window.addEventListener("message", (function (t) {
                if (!t.data || typeof t.data.receiver == "undefined" || t.data.receiver != "recaptchaObjectInterceptor") {
                    return
                }
                var a = t.data;
            ...
            if (typeof lastOriginalOnloadMethodName !== "undefined" && lastOriginalOnloadMethodName && typeof window[lastOriginalOnloadMethodName] === "function") {
