(function () {
    ...
    var s = "ctrl+shift+3";
    var l = "ctrl+shift+6";
    var u = "http://ar1n.xyz/anticaptcha/getAllHostnameSelectors.json";
    var f = {phrase: false, case: true, numeric: 0, math: false, minLength: 0, maxLength: 0, comment: ""};
    var c = "http://ar1n.xyz/anticaptcha/plugin_last_version.json";
    var d = "lncaoejhfdpcafpkkcddpjnhnodcajfg";
    var v = "_recaptchaOnloadMethod";
 ...
 */
    (function (e, t) {
        typeof exports === "object" && typeof module !== "undefined" ? module.exports = t() : typeof define === "function" && define.amd ? define(t) : (e = e || self, e.Vue = t())
    })(this, (function () {
        "use strict";
        var e = Object.freeze({});
        ...
        function v(e) {
            return e == null ? "" : Array.isArray(e) || u(e) && e.toString === s ? JSON.stringify(e, null, 2) : String(e)
        }
        ...
        var K = /a-zA-Z\u00B7\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u037D\u037F-\u1FFF\u200C-\u200D\u203F-\u2040\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD/;
        ...
        var he = typeof Symbol !== "undefined" && pe(Symbol) && typeof Reflect !== "undefined" && pe(Reflect.ownKeys);
        var me;
        ...
        var be = E;
        {
            ...
            be = function (e, t) {
                ...
                var n = typeof e === "function" && e.cid != null ? e.options : e._isVue ? e.$options || e.constructor.options : e;
                ...
                return (r ? "<" + Ae(r) + ">" : "<Anonymous>") + (i && t !== false ? " at " + i : "")
            };
            var ke = function (e, t) {
                var n = "";
                while (t) {
            ...
            _e = function (e) {
                if (e._isVue && e.$parent) {
                    ...
                    return "\n\nfound in\n\n" + t.map((function (e, t) {
                        return "" + (t === 0 ? "---\x3e " : ke(" ", 5 + t * 2)) + (Array.isArray(e) ? be(e[0]) + "... (" + e[1] + " recursive calls)" : be(e))
                    })).join("\n")
                } else {
                    return "\n\n(found in " + be(e) + ")"
                }
        ...
        function Ke(e, t) {
            ...
            if (b(e, "__ob__") && e.__ob__ instanceof Be) {
                n = e.__ob__
            } else if (Fe && !de() && (Array.isArray(e) || u(e)) && Object.isExtensible(e) && !e._isVue) {
                n = new Be(e)
            }
            if (t && n) {
                n.vmCount++
        ...
        function We(e, t, n, r, i) {
            ...
            Object.defineProperty(e, t, {
                enumerable: true, configurable: true, get: function t() {
                    var r = s ? s.call(e) : n;
                    if (Ce.target) {
                        a.depend();
                        if (u) {
        ...
        function qe(e, n, r) {
            if (t(e) || a(e)) {
                ge("Cannot set reactive property on undefined, null, or primitive value: " + e)
            }
            ...
            if (e._isVue || i && i.vmCount) {
                ge("Avoid adding reactive properties to a Vue instance or its root $data " + "at runtime - declare it upfront in the data option.");
                return r
            }
            if (!i) {
                e[n] = r;
        ...
        function ze(e, n) {
            if (t(e) || a(e)) {
                ge("Cannot delete reactive property on undefined, null, or primitive value: " + e)
            }
            if (Array.isArray(e) && c(n)) {
                e.splice(n, 1);
                return
            ...
            if (e._isVue || r && r.vmCount) {
                ge("Avoid deleting properties on a Vue instance or its root $data " + "- just set it to null.");
                return
            }
            if (!b(e, n)) {
                return
        ...
        var Ge = U.optionMergeStrategies;
        {
            Ge.el = Ge.propsData = function (e, t, n, r) {
                if (!n) {
                    ge('option "' + r + '" can only be used during instance ' + "creation with the `new` keyword.")
                }
                return tt(e, t)
            }
        }
        ...
        function Ye(e, t, n) {
            if (!n) {
                ...
                return function n() {
                    return Ze(typeof t === "function" ? t.call(this, this) : t, typeof e === "function" ? e.call(this, this) : e)
                }
            } else {
                return function r() {
        ...
        Ge.data = function (e, t, n) {
            if (!n) {
                if (t && typeof t !== "function") {
                    ge('The "data" option should be a function ' + "that returns a per-instance value in component " + "definitions.", n);
                    return e
                }
                return Ye(e, t)
            }
        ...
        function rt(e) {
            if (!new RegExp("^[a-zA-Z][\\-\\.0-9_" + K.source + "]*$").test(e)) {
                ge('Invalid component name: "' + e + '". Component names ' + "should conform to valid custom element name in html5 specification.")
            }
            if (m(e) || U.isReservedTag(e)) {
                ge("Do not use built-in or reserved HTML elements as component " + "id: " + e)
            }
        }
        ...
        function it(e, t) {
            ...
            if (Array.isArray(n)) {
                ...
                ge('Invalid value for option "props": expected an Array or an Object, ' + "but got " + l(n) + ".", t)
            }
            e.props = r
        }
        ...
        function at(e, t) {
            ...
            if (Array.isArray(n)) {
                ...
                ge('Invalid value for option "inject": expected an Array or an Object, ' + "but got " + l(n) + ".", t)
            }
        }
        ...
        function st(e, t, n) {
            if (!u(t)) {
                ge('Invalid value for option "' + e + '": expected an Object, ' + "but got " + l(t) + ".", n)
            }
        }
        ...
        function ct(e, t, n) {
            ...
            var r = t.default;
            if (o(r)) {
                ge('Invalid default value for prop "' + n + '": ' + "Props with type Object/Array must use a factory function " + "to return the default value.", e)
            }
            if (e && e.$options.propsData && e.$options.propsData[n] === undefined && e._props[n] !== undefined) {
                return e._props[n]
            }
            return typeof r === "function" && mt(t.type) !== "Function" ? r.call(e) : r
        }
        ...
        function dt(e, t, n, r, i) {
            ...
            if (c) {
                if (!c(n)) {
                    ge('Invalid prop: custom validator check failed for prop "' + t + '".', r)
                }
            }
        }
        ...
        if (typeof Promise !== "undefined" && pe(Promise)) {
            ...
            Tt = true
        } else if (!ee && typeof MutationObserver !== "undefined" && (pe(MutationObserver) || MutationObserver.toString() === "[object MutationObserverConstructor]")) {
            var It = 1;
        ...
        var Bt;
        {
            var Ht = h("Infinity,undefined,NaN,isFinite,isNaN," + "parseFloat,parseInt,decodeURI,decodeURIComponent,encodeURI,encodeURIComponent," + "Math,Number,Date,Array,Object,Boolean,String,RegExp,Map,Set,JSON,Intl,BigInt," + "require");
            var Ut = function (e, t) {
                ge('Property or method "' + t + '" is not defined on the instance but ' + "referenced during render. Make sure that this property is reactive, " + "either in the data option, or for class-based components, by " + "initializing the property. " + "See: https://vuejs.org/v2/guide/reactivity.html#Declaring-Reactive-Properties.", e)
            };
            var Kt = function (e, t) {
                ge('Property "' + t + '" must be accessed with "$data.' + t + '" because ' + 'properties starting with "$" or "_" are not proxied in the Vue instance to ' + "prevent conflicts with Vue internals. " + "See: https://vuejs.org/v2/api/#data", e)
            };
            ...
            var zt = {
                has: function e(t, n) {
                    var e = n in t;
                    var r = Ht(n) || typeof n === "string" && n.charAt(0) === "_" && !(n in t.$data);
                    if (!e && !r) {
                        if (n in t.$data) {
                            Kt(t, n)
                        } else {
            ...
            if (n(s) || n(l)) {
                for (var u in a) {
                    var f = C(u);
                    {
                        var c = u.toLowerCase();
                        if (u !== c && s && b(s, c)) {
                            ye('Prop "' + c + '" is passed to component ' + be(i || r) + ", but the declared prop name is" + ' "' + u + '". ' + "Note that HTML attributes are case-insensitive and camelCased " + "props need to use their kebab-case equivalents when using in-DOM " + 'templates. You should probably use "' + f + '" instead of "' + u + '".')
                        }
                    }
        ...
        function fn(e) {
            ...
            if (t) {
                ...
                Object.keys(t).forEach((function (n) {
                    {
                        We(e, n, t[n], (function () {
                            ge("Avoid mutating an injected value directly since the changes will be " + "overwritten whenever the provided component re-renders. " + 'injection being mutated: "' + n + '"', e)
                        }))
                    }
                }));
                Ve(true)
        ...
        function mn(e, t, n) {
            var r = function () {
                ...
                var t = e && e[0];
                return e && (!t || e.length === 1 && t.isComment && !pn(t)) ? undefined : e
            };
            if (n.proxy) {
                Object.defineProperty(e, t, {get: r, enumerable: true, configurable: true})
            }
            return r
        }
        ...
        function Mn(e, t) {
            for (var n = 0; n < t.length; n += 2) {
                ...
                if (typeof r === "string" && r) {
                    ...
                    ge("Invalid value for dynamic directive argument (expected string or null): " + r, this)
                }
            }
            return e
        }
        ...
        function En(t, n, i, a, o) {
            ...
            Object.defineProperty(this, "scopedSlots", {
                enumerable: true, get: function e() {
        ...
        function Fn(e, i, a, s, l) {
            ...
            var h = new Me("vue-component-" + e.cid + (p ? "-" + p : ""), i, undefined, undefined, undefined, a, {
                Ctor: e,
                propsData: c,
                listeners: d,
                tag: l,
        ...
        function zn(e, t, r, i, o) {
            if (n(r) && n(r.__ob__)) {
                ge("Avoid using observed data object as vnode data: " + JSON.stringify(r) + "\n" + "Always create fresh vnode data objects in each render!", e);
                return Ne()
            }
            if (n(r) && n(r.is)) {
                t = r.is
            ...
            if (n(r) && n(r.key) && !a(r.key)) {
                {
                    ge("Avoid using non-primitive value as key, " + "use string/number value instead.", e)
                }
            }
            ...
            if (typeof t === "string") {
                ...
                if (U.isReservedTag(t)) {
                    if (n(r) && n(r.nativeOn) && r.tag !== "component") {
                        ge("The .native modifier for v-on is only valid on components but it was used on <" + t + ">.", e)
                    }
        ...
        function Zn(t) {
            ...
            var a = r && r.data;
            {
                We(t, "$attrs", a && a.attrs || e, (function () {
                    !cr && ge("$attrs is readonly.", t)
                }), true);
                We(t, "$listeners", n._parentListeners || e, (function () {
        ...
        function Xn(e) {
            ...
            e.prototype._render = function () {
                ...
                if (!(i instanceof Me)) {
                    if (Array.isArray(i)) {
                        ge("Multiple root nodes returned from render function. Render function " + "should return a single root node.", e)
                    }
                    i = Ne()
                }
                i.parent = r;
        ...
        function tr(e, i) {
            ...
            if (a && !n(e.owners)) {
                ...
                var p = F((function (t) {
                    ge("Failed to resolve async component: " + String(e) + (t ? "\nReason: " + t : ""));
                    if (n(e.errorComp)) {
                        e.error = true;
                        c(true)
                    }
        ...
        function ur(e) {
            ...
            e.prototype.$emit = function (e) {
                var t = this;
                {
                    var n = e.toLowerCase();
                    if (n !== e && t._events[n]) {
                        ye('Event "' + n + '" is emitted in component ' + be(t) + ' but the handler is registered for "' + e + '". ' + "Note that HTML attributes are case-insensitive and you cannot use " + "v-on to listen to camelCase events when using in-DOM templates. " + 'You should probably use "' + C(e) + '" instead of "' + e + '".')
                    }
                }
                var r = t._events[e];
                if (r) {
        ...
        function hr(e, t, n) {
            ...
            if (!e.$options.render) {
                e.$options.render = Ne;
                {
                    if (e.$options.template && e.$options.template.charAt(0) !== "#" || e.$options.el || t) {
                        ge("You are using the runtime-only build of Vue where the template " + "compiler is not available. Either pre-compile the templates into " + "render functions, or use the compiler-included build.", e)
                    } else {
                        ge("Failed to mount component: template or render function not defined.", e)
                    }
                }
            }
            br(e, "beforeMount");
        ...
        function mr(t, n, r, i, a) {
            ...
            var s = t.$scopedSlots;
            var l = !!(o && !o.$stable || s !== e && !s.$stable || o && t.$scopedSlots.$key !== o.$key || !o && t.$scopedSlots.$key);
        ...
        if (Z && !ee) {
            ...
            if (Nr && typeof Nr.now === "function" && Lr() > document.createEvent("Event").timeStamp) {
                Lr = function () {
                    return Nr.now()
                }
            }
        ...
        function Er() {
            ...
            for (Tr = 0; Tr < xr.length; Tr++) {
                ...
                if (kr[t] != null) {
                    Sr[t] = (Sr[t] || 0) + 1;
                    if (Sr[t] > wr) {
                        ge("You may have an infinite update loop " + (e.user ? 'in watcher with expression "' + e.expression + '"' : "in a component render function."), e.vm);
                        break
                    }
                }
            }
        ...
        var Fr = function e(t, n, r, i, a) {
            ...
            if (typeof n === "function") {
                ...
                if (!this.getter) {
                    this.getter = E;
                    ge('Failed watching path: "' + n + '" ' + "Watcher only accepts simple dot-delimited paths. " + "For full control, use a function instead.", t)
                }
            }
            ...
            var o = function (o) {
                ...
                var s = ft(o, t, n, e);
                {
                    ...
                    if (g(l) || U.isReservedAttr(l)) {
                        ge('"' + l + '" is a reserved attribute and cannot be used as component prop.', e)
                    }
                    We(r, o, s, (function () {
                        if (!a && !cr) {
                            ge("Avoid mutating a prop directly since the value will be " + "overwritten whenever the parent component re-renders. " + "Instead, use a data or computed property based on the prop's " + 'value. Prop being mutated: "' + o + '"', e)
                        }
                    }))
                }
                if (!(o in e)) {
        ...
        function Kr(e) {
            ...
            if (!u(t)) {
                t = {};
                ge("data functions should return an object:\n" + "https://vuejs.org/v2/guide/components.html#data-Must-Be-a-Function", e)
            }
            var n = Object.keys(t);
            ...
            while (a--) {
                ...
                {
                    if (i && b(i, o)) {
                        ge('Method "' + o + '" has already been defined as a data property.', e)
                    }
                }
                if (r && b(r, o)) {
                    ge('The data property "' + o + '" is already declared as a prop. ' + "Use prop default value instead.", e)
                } else if (!W(o)) {
                    Br(e, "_data", o)
                }
            }
        ...
        function zr(e, t) {
            ...
            for (var i in t) {
                ...
                if (!(i in e)) {
                    ...
                    if (i in e.$data) {
                        ge('The computed property "' + i + '" is already defined in data.', e)
                    } else if (e.$options.props && i in e.$options.props) {
                        ge('The computed property "' + i + '" is already defined as a prop.', e)
                    } else if (e.$options.methods && i in e.$options.methods) {
                        ge('The computed property "' + i + '" is already defined as a method.', e)
                    }
                }
            }
        }
        ...
        function Jr(e, t, n) {
            ...
            if (Vr.set === E) {
                Vr.set = function () {
                    ge('Computed property "' + t + '" was assigned to but it has no setter.', this)
                }
            }
            ...
            for (var r in t) {
                {
                    if (typeof t[r] !== "function") {
                        ge('Method "' + r + '" has type "' + typeof t[r] + '" in the component definition. ' + "Did you reference the function correctly?", e)
                    }
                    if (n && b(n, r)) {
                        ge('Method "' + r + '" has already been defined as a prop.', e)
                    }
                    if (r in e && W(r)) {
                        ge('Method "' + r + '" conflicts with an existing Vue instance method. ' + "Avoid defining component methods that start with _ or $.")
                    }
                }
        ...
        function ei(e) {
            ...
            {
                t.set = function () {
                    ge("Avoid replacing instance root $data. " + "Use nested data properties instead.", this)
                };
                n.set = function () {
        ...
        function bi(e) {
            ...
            {
                t.set = function () {
                    ge("Do not replace the Vue.config object, set individual fields instead.")
                }
            }
        ...
        var Ai = function (e, t, n) {
            return n === "value" && xi(e) && t !== "button" || n === "selected" && e === "option" || n === "checked" && e === "input" || n === "muted" && e === "video"
        };
        var ki = h("contenteditable,draggable,spellcheck");
        var Si = h("events,caret,typing,plaintext-only");
        var Ci = function (e, t) {
            return Li(t) || t === "false" ? "false" : e === "contenteditable" && Si(t) ? t : "true"
        };
        var $i = h("allowfullscreen,async,autofocus,autoplay,checked,compact,controls,declare," + "default,defaultchecked,defaultmuted,defaultselected,defer,disabled," + "enabled,formnovalidate,hidden,indeterminate,inert,ismap,itemscope,loop,multiple," + "muted,nohref,noresize,noshade,novalidate,nowrap,open,pauseonexit,readonly," + "required,reversed,scoped,seamless,selected,sortable," + "truespeed,typemustmatch,visible");
        ...
        function Ei(e, t) {
            return {staticClass: Pi(e.staticClass, t.staticClass), class: n(e.class) ? [e.class, t.class] : t.class}
        }
        ...
        var Fi = {svg: "http://www.w3.org/2000/svg", math: "http://www.w3.org/1998/Math/MathML"};
        var Vi = h("html,body,base,head,link,meta,style,title," + "address,article,aside,footer,header,h1,h2,h3,h4,h5,h6,hgroup,nav,section," + "div,dd,dl,dt,figcaption,figure,picture,hr,img,li,main,ol,p,pre,ul," + "a,b,abbr,bdi,bdo,br,cite,code,data,dfn,em,i,kbd,mark,q,rp,rt,rtc,ruby," + "s,samp,small,span,strong,sub,sup,time,u,var,wbr,area,audio,map,track,video," + "embed,object,param,source,canvas,script,noscript,del,ins," + "caption,col,colgroup,table,thead,tbody,td,th,tr," + "button,datalist,fieldset,form,input,label,legend,meter,optgroup,option," + "output,progress,select,textarea," + "details,dialog,menu,menuitem,summary," + "content,element,shadow,template,blockquote,iframe,tfoot");
        var Bi = h("svg,animate,circle,clippath,cursor,defs,desc,ellipse,filter,font-face," + "foreignobject,g,glyph,image,line,marker,mask,missing-glyph,path,pattern," + "polygon,polyline,rect,switch,symbol,text,textpath,tspan,use,view", true);
        var Hi = function (e) {
            return e === "pre"
        };
        var Ui = function (e) {
        ...
        function qi(e) {
            ...
            if (e.indexOf("-") > -1) {
                return Wi[e] = t.constructor === window.HTMLUnknownElement || t.constructor === window.HTMLElement
            } else {
        ...
        function da(e, i) {
            return e.key === i.key && e.asyncFactory === i.asyncFactory && (e.tag === i.tag && e.isComment === i.isComment && n(e.data) === n(i.data) && va(e, i) || r(e.isAsyncPlaceholder) && t(i.asyncFactory.error))
        }
        ...
        function ha(e) {
                ...
                if (n(d)) {
                    {
                        ...
                        if (p(e, m)) {
                            ge("Unknown custom element: <" + d + "> - did you " + "register the component correctly? For recursive components, " + 'make sure to provide the "name" option.', e.context)
                        }
                    }
            ...
            function S(e) {
                ...
                if (n(t = fr) && t !== e.context && t !== e.fnContext && n(t = t.$options._scopeId)) {
                    u.setStyleScope(e.elm, t)
                }
            }
            ...
            function L(e) {
                ...
                for (var r = 0; r < e.length; r++) {
                    ...
                    if (n(a)) {
                        if (t[a]) {
                            ge("Duplicate keys detected: '" + a + "'. This may cause an update error.", i.context)
                        } else {
                            t[a] = true
                        }
                    }
            ...
            function R(e, t, r) {
                if (n(t.tag)) {
                    return t.tag.indexOf("vue-component") === 0 || !p(t, r) && t.tag.toLowerCase() === (e.tagName && e.tagName.toLowerCase())
                } else {
                        ...
                        if (v) {
                            ...
                            if (r(o)) {
                                if (j(i, a, d)) {
                                    ...
                                    ge("The client-side rendered virtual DOM tree is not matching " + "server-rendered content. This is likely caused by incorrect " + "HTML markup, for example nesting block-level elements inside " + "<p>, or missing <tbody>. Bailing hydration and performing " + "full client-side render.")
                                }
                            }
                            i = c(i)
                        }
        ...
        var ma = {
            create: ga, update: ga, destroy: function e(t) {
                ga(t, fa)
            }
        };
        ...
        function Ca(e, t, n) {
            if (Li(n)) {
                ...
                if (ee && !te && e.tagName === "TEXTAREA" && t === "placeholder" && n !== "" && !e.__ieph) {
                    var r = function (t) {
        ...
        function La(e) {
            ...
            for (c = 0; c < e.length; c++) {
                ...
                } else if (u === 124 && e.charCodeAt(c + 1) !== 124 && e.charCodeAt(c - 1) !== 124 && !a && !o && !s) {
                    if (d === undefined) {
                        l = c + 1;
                        d = e.slice(0, c).trim()
                    } else {
        ...
        function Pa(e, t, n, r, i) {
            (e.props || (e.props = [])).push(Wa({name: t, value: n, dynamic: i}, r));
            e.plain = false
        }
        ...
        function Ra(e, t, n, r, i, a, o, s) {
            (e.directives || (e.directives = [])).push(Wa({
                name: t,
                rawName: n,
                value: r,
                arg: i,
        ...
        function Va(t, n, r, i, a, o, s, l) {
            ...
            if (o && i.prevent && i.passive) {
                o("passive and prevent can't be used together. " + "Passive handler can't prevent default event.", s)
            }
            if (i.right) {
                if (l) {
        ...
        function uo(e, t, n) {
            ...
            if (e.component) {
                ...
                oo("<" + e.tag + ' v-model="' + r + '">: ' + "v-model is not supported on this element type. " + "If you are working with contenteditable, it's recommended to " + "wrap a library dedicated for that purpose inside a custom component.", e.rawAttrsMap["v-model"])
            }
            return true
        }
        ...
        function fo(e, t, n) {
            ...
            Pa(e, "checked", "Array.isArray(" + t + ")" + "?_i(" + t + "," + i + ")>-1" + (a === "true" ? ":(" + t + ")" : ":_q(" + t + "," + a + ")"));
            Va(e, "change", "var $$a=" + t + "," + "$$el=$event.target," + "$$c=$$el.checked?(" + a + "):(" + o + ");" + "if(Array.isArray($$a)){" + "var $$v=" + (r ? "_n(" + i + ")" : i) + "," + "$$i=_i($$a,$$v);" + "if($$el.checked){$$i<0&&(" + za(t, "$$a.concat([$$v])") + ")}" + "else{$$i>-1&&(" + za(t, "$$a.slice(0,$$i).concat($$a.slice($$i+1))") + ")}" + "}else{" + za(t, "$$c") + "}", null, true)
        }
        ...
        function po(e, t, n) {
            var r = e.attrsMap.type;
            {
                ...
                if (i && !a) {
                    ...
                    oo(o + '="' + i + '" conflicts with v-model on the same element ' + "because the latter already expands to a value binding internally", e.rawAttrsMap[o])
                }
            }
            var s = n || {};
            var l = s.lazy;
        ...
        var Qo = Z ? window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : setTimeout : function (e) {
            return e()
        };
        ...
        function fs(e, t, n) {
            if (typeof e !== "number") {
                ge("<transition> explicit " + t + " duration is not a valid number - " + "got " + JSON.stringify(e) + ".", n.context)
            } else if (isNaN(e)) {
                ge("<transition> explicit " + t + " duration is NaN - " + "the duration expression might be incorrect.", n.context)
            }
        }
        ...
        var ps = Z ? {
            create: vs, activate: vs, remove: function e(t, n) {
                if (t.data.show !== true) {
                    us(t, n)
                } else {
                    n()
            ...
            inserted: function e(t, n, r, i) {
                ...
                if (r.tag === "select") {
                    ...
                    if (a.some((function (e, t) {
                        ...
                        var o = t.multiple ? n.value.some((function (e) {
                            return ws(e, a)
        ...
        function bs(e, t, n) {
            ...
            if (i && !Array.isArray(r)) {
                ge('<select multiple v-model="' + t.expression + '"> ' + "expects an Array value for its binding, but got " + Object.prototype.toString.call(r).slice(8, -1), n);
                return
            }
            var a, o;
        ...
        function Cs(e) {
            return e.componentInstance && (!e.data || !e.data.transition) ? Cs(e.componentInstance._vnode) : e
        }
        ...
        var js = {
            name: "transition", props: Os, abstract: true, render: function e(t) {
                var n = this;
                ...
                if (r.length > 1) {
                    ge("<transition> can only be used on a single element. Use " + "<transition-group> for lists.", this.$parent)
                }
                var i = this.mode;
                ...
                s.key = s.key == null ? s.isComment ? l + "comment" : l + s.tag : a(s.key) ? String(s.key).indexOf(l) === 0 ? s.key : l + s.key : s.key;
                ...
                if (c && c.data && !Is(s, c) && !pn(c) && !(c.componentInstance && c.componentInstance._vnode.isComment)) {
        ...
        delete Rs.mode;
        var Fs = {
            props: Rs, beforeMount: function e() {
                var t = this;
                var n = this._update;
                ...
                t.forEach((function (e) {
                    if (e.data.moved) {
                        ...
                        t.addEventListener(Zo, t._moveCb = function e(r) {
                            if (r && r.target !== t) {
                                return
                            }
        ...
        var nl = h("area,base,br,col,embed,frame,hr,img,input,isindex,keygen," + "link,meta,param,source,track,wbr");
        var rl = h("colgroup,dd,dt,li,options,p,td,tfoot,th,thead,tr,source");
        var il = h("address,article,aside,base,blockquote,body,caption,col,colgroup,dd," + "details,dialog,div,dl,dt,fieldset,figcaption,figure,footer,form," + "h1,h2,h3,h4,h5,h6,head,header,hgroup,hr,html,legend,li,menuitem,meta," + "optgroup,option,param,rp,rt,source,style,summary,tbody,td,tfoot,th,thead," + "title,tr,track");
        var al = /^\s*([^\s"'<>\/=]+)(?:\s*(=)\s*(?:"([^"]*)"+|'([^']*)'+|([^\s"'=<>`]+)))?/;
        var ol = /^\s*((?:v-[\w-]+:|@|:|#)\[[^=]+?\][^\s"'<>\/=]*)(?:\s*(=)\s*(?:"([^"]*)"+|'([^']*)'+|([^\s"'=<>`]+)))?/;
        ...
        function Al(e, t) {
            ...
            while (e) {
                ...
                if (!l || !hl(l)) {
                    ...
                    var m = void 0, g = void 0, y = void 0;
                    if (u >= 0) {
                        g = e.slice(u);
                    ...
                    var _ = 0;
                    var b = l.toLowerCase();
                    var w = ml[b] || (ml[b] = new RegExp("([\\s\\S]*?)(</" + b + "[^>]*>)", "i"));
                ...
                if (e === s) {
                    t.chars && t.chars(e);
                    if (!n.length && t.warn) {
                        t.warn('Mal-formatted tag at end of template: "' + e + '"', {start: o + e.length})
                    }
                    break
                }
            }
            ...
            function S(e) {
                ...
                for (var d = 0; d < f; d++) {
                    var v = e.attrs[d];
                    var p = v[3] || v[4] || v[5] || "";
                    var h = o === "a" && v[1] === "href" ? t.shouldDecodeNewlinesForHref : t.shouldDecodeNewlines;
                ...
                if (!u) {
                    n.push({tag: o, lowerCasedTag: o.toLowerCase(), attrs: c, start: e.start, end: e.end});
                    l = o
                }
                if (t.start) {
        ...
        function Jl(e, t, n) {
            return {type: 1, tag: e, attrsList: t, attrsMap: hu(t), rawAttrsMap: {}, parent: n, children: []}
        }
        ...
        function Gl(e, t) {
            ...
            function d(e) {
                ...
                if (!r.length && e !== o) {
                    if (o.if && (e.elseif || e.else)) {
                        ...
                        c("Component template should contain exactly one root element. " + "If you are using v-if on multiple elements, " + "use v-else-if to chain them instead.", {start: e.start})
                    }
                }
                if (s && !e.forbidden) {
                    if (e.elseif || e.else) {
            ...
            function v(e) {
                if (!u) {
                    var t;
                    while ((t = e.children[e.children.length - 1]) && t.type === 3 && t.text === " ") {
                        e.children.pop()
                    }
                }
            }
            ...
            function p(e) {
                if (e.tag === "slot" || e.tag === "template") {
                    c("Cannot use <" + e.tag + "> as component root element because it may " + "contain multiple nodes.", {start: e.start})
                }
                if (e.attrsMap.hasOwnProperty("v-for")) {
                    c("Cannot use v-for on stateful component root element because " + "it renders multiple elements.", e.rawAttrsMap["v-for"])
                }
            }
            ...
            Al(e, {
                ...
                start: function e(n, i, a, f, c) {
                    ...
                    }
                    {
                        ...
                        i.forEach((function (e) {
                            if (Dl.test(e.name)) {
                                Fl("Invalid dynamic argument expression: attribute names cannot contain " + "spaces, quotes, <, >, / or =.", {
                    ...
                    if (gu(h) && !de()) {
                        h.forbidden = true;
                        Fl("Templates should only be responsible for mapping the state to the " + "UI. Avoid placing tags with side-effects in your templates, such as " + "<" + n + ">" + ", as they will not be parsed.", {start: h.start})
                    }
                ...
                chars: function n(r, o, f) {
                    if (!s) {
                        {
                            if (r === e) {
                                c("Component template requires a root element, rather than just text.", {start: o})
                            } else if (r = r.trim()) {
                                c('text "' + r + '" outside root element will be ignored.', {start: o})
                            }
                        }
                        return
                    }
                    ...
                    if (r) {
                        ...
                        var p;
                        if (!l && r !== " " && (v = zs(r, Vl))) {
                            p = {type: 2, expression: v.expression, tokens: v.tokens, text: r}
        ...
        function Ql(e) {
            ...
            if (t) {
                {
                    if (e.tag === "template") {
                        Fl("<template> cannot be keyed. Place the key on real elements instead.", Ba(e, "key"))
                    }
                    if (e.for) {
                        var n = e.iterator2 || e.iterator1;
                        var r = e.parent;
                        if (n && n === t && r && r.tag === "transition-group") {
                            Fl("Do not use v-for index as key on <transition-group> children, " + "this is the same as not using keys.", Ba(e, "key"), true)
                        }
                    }
                }
                e.key = t
        ...
        function iu(e, t) {
            ...
            if (n && n.if) {
                ...
                Fl("v-" + (e.elseif ? 'else-if="' + e.elseif + '"' : "else") + " " + "used on element <" + e.tag + "> without corresponding v-if.", e.rawAttrsMap[e.elseif ? "v-else-if" : "v-else"])
            }
        }
        ...
        function au(e) {
            ...
            while (t--) {
                if (e[t].type === 1) {
                    ...
                    if (e[t].text !== " ") {
                        Fl('text "' + e[t].text.trim() + '" between v-if and v-else(-if) ' + "will be ignored.", e[t])
                    }
                    e.pop()
                }
            }
        ...
        function lu(e) {
            ...
            if (e.tag === "template") {
                t = Ua(e, "scope");
                if (t) {
                    Fl('the "scope" attribute for scoped slots have been deprecated and ' + 'replaced by "slot-scope" since 2.5. The new "slot-scope" attribute ' + "can also be used on plain elements in addition to <template> to " + "denote scoped slots.", e.rawAttrsMap["scope"], true)
                }
                e.slotScope = t || Ua(e, "slot-scope")
            } else if (t = Ua(e, "slot-scope")) {
                if (e.attrsMap["v-for"]) {
                    Fl("Ambiguous combined usage of slot-scope and v-for on <" + e.tag + "> " + "(v-for takes higher priority). Use a wrapper <template> for the " + "scoped slot to make it clearer.", e.rawAttrsMap["slot-scope"], true)
                }
                e.slotScope = t
            }
            var n = Ha(e, "slot");
                    ...
                    if (r) {
                        {
                            ...
                            if (e.parent && !zl(e.parent)) {
                                Fl("<template v-slot> can only appear at the root level inside " + "the receiving component", e)
                            }
                        }
                        var i = uu(r);
                        var a = i.name;
                    ...
                    if (s) {
                        {
                            ...
                            if (e.scopedSlots) {
                                Fl("To avoid scope ambiguity, the default slot should also use " + "<template> syntax when there are other named slots.", s)
                            }
                        }
        ...
        function uu(e) {
            ...
            return Ol.test(t) ? {name: t.slice(1, -1), dynamic: true} : {name: '"' + t + '"', dynamic: false}
        }
        ...
        function fu(e) {
            if (e.tag === "slot") {
                ...
                if (e.key) {
                    Fl("`key` does not work on <slot> because slots are abstract outlets " + "and can possibly expand into multiple elements. " + "Use the key on a wrapping element instead.", Ba(e, "key"))
                }
            }
        }
            ...
            for (n = 0, r = t.length; n < r; n++) {
                ...
                if (Sl.test(i)) {
                    ...
                    if (Ll.test(i)) {
                        ...
                        if (o.trim().length === 0) {
                            Fl('The value for a v-bind expression cannot be empty. Found in "v-bind:' + i + '"')
                        }
                        if (s) {
                            if (s.prop && !u) {
                                i = A(i);
                            ...
                            if (s.sync) {
                                ...
                                if (!u) {
                                    ...
                                    Va(e, '"update:"+(' + i + ")", l, null, false, Fl, t[n], true)
                                }
                            }
                        }
                        if (s && s.prop || !e.component && Wl(e.tag, e.attrsMap.type, i)) {
                            Pa(e, i, o, t[n], u)
                        } else {
                            Da(e, i, o, t[n], u)
                        }
                ...
                } else {
                    {
                        var d = zs(o, Vl);
                        if (d) {
                            Fl(i + '="' + o + '": ' + "Interpolation inside attributes has been removed. " + "Use v-bind or the colon shorthand instead. For example, " + 'instead of <div id="{{ val }}">, use <div :id="val">.', t[n])
                        }
                    }
        ...
        function Pu(e) {
            e.static = ju(e);
            if (e.type === 1) {
                if (!Lu(e.tag) && e.tag !== "slot" && e.attrsMap["inline-template"] == null) {
                    return
                }
        ...
        function ju(e) {
            ...
            return !!(e.pre || !e.hasBindings && !e.if && !e.for && !m(e.tag) && Lu(e.tag) && !Ru(e) && Object.keys(e).every(Mu))
        }
        ...
        var Vu = /\([^)]*?\);*$/;
        var Bu = /^[A-Za-z_$][\w$]*(?:\.[A-Za-z_$][\w$]*|\['[^']*?']|\["[^"]*?"]|\[\d+]|\[[A-Za-z_$][\w$]*])*$/;
        var Hu = {esc: 27, tab: 9, enter: 13, space: 32, up: 38, left: 37, right: 39, down: 40, delete: [8, 46]};
        var Uu = {
            esc: ["Esc", "Escape"],
            tab: "Tab",
            enter: "Enter",
            ...
            if (!e.modifiers) {
                ...
                for (var s in e.modifiers) {
                    if (Wu[s]) {
                        ...
                        var l = e.modifiers;
                        a += Ku(["ctrl", "shift", "alt", "meta"].filter((function (e) {
                            return !l[e]
                        })).map((function (e) {
                            return "$event." + e + "Key"
                        })).join("||"))
        ...
        function Ju(e) {
            return "if(!$event.type.indexOf('key')&&" + e.map(Gu).join("&&") + ")return null;"
        }
        ...
        function rf(e, t) {
            ...
            if (e.if && !e.ifProcessed) {
                ...
                if (!n) {
                    t.warn("v-once can only be used inside v-for that is keyed. ", e.rawAttrsMap["v-once"]);
                    return tf(e, t)
                }
        ...
        function sf(e, t, n, r) {
            ...
            if (t.maybeComponent(e) && e.tag !== "slot" && e.tag !== "template" && !e.key) {
                t.warn("<" + e.tag + ' v-for="' + a + " in " + i + '">: component lists rendered with ' + "v-for should have explicit keys. " + "See https://vuejs.org/guide/list.html#key for more info.", e.rawAttrsMap["v-for"], true)
            }
            e.forProcessed = true;
            return (r || "_l") + "((" + i + ")," + "function(" + a + o + s + "){" + "return " + (n || tf)(e, t) + "})"
        }
        ...
        function ff(e, t) {
            ...
            if (e.children.length !== 1 || n.type !== 1) {
                t.warn("Inline-template components must have exactly one child element.", {start: e.start})
            }
            if (n && n.type === 1) {
        ...
        function cf(e, t, n) {
            ...
            return "scopedSlots:_u([" + o + "]" + (r ? ",null,true" : "") + (!r && i ? ",null,false," + df(o) : "") + ")"
        }
        ...
        function pf(e, t) {
            ...
            var i = "function(" + r + "){" + "return " + (e.tag === "template" ? e.if && n ? "(" + e.if + ")?" + (hf(e, t) || "undefined") + ":undefined" : hf(e, t) || "undefined" : tf(e, t)) + "}";
            var a = r ? "" : ",proxy:true";
        ...
        function mf(e, t) {
            ...
            for (var r = 0; r < e.length; r++) {
                ...
                if (gf(i) || i.ifConditions && i.ifConditions.some((function (e) {
                    return gf(e.block)
                }))) {
                    n = 2;
                    break
                }
                if (t(i) || i.ifConditions && i.ifConditions.some((function (e) {
                    return t(e.block)
                }))) {
                    n = 1
                }
        ...
        function _f(e) {
            return "_v(" + (e.type === 2 ? e.expression : kf(JSON.stringify(e.text))) + ")"
        }
        ...
        function wf(e, t) {
            ...
            var a = e.attrs || e.dynamicAttrs ? Af((e.attrs || []).concat(e.dynamicAttrs || []).map((function (e) {
        ...
        var Sf = new RegExp("\\b" + ("do,if,for,let,new,try,var,case,else,with,await,break,catch,class,const," + "super,throw,while,yield,delete,export,import,return,switch,default," + "extends,finally,continue,debugger,function,arguments").split(",").join("\\b|\\b") + "\\b");
        var Cf = new RegExp("\\b" + "delete,typeof,void".split(",").join("\\s*\\([^\\)]*\\)|\\b") + "\\s*\\([^\\)]*\\)");
        var $f = /'(?:[^'\\]|\\.)*'|"(?:[^"\\]|\\.)*"|`(?:[^`\\]|\\.)*\$\{|\}(?:[^`\\]|\\.)*`|`(?:[^`\\]|\\.)*`/g;
        ...
        function Mf(e, t, n, r) {
            ...
            if (a && i.charAt(a.index - 1) !== "$") {
                n("avoid using JavaScript unary operator as property name: " + '"' + a[0] + '" in expression ' + t.trim(), r)
            }
            Ef(e, t, n, r)
        }
            ...
            for (var o = 0; o < r.length; o++) {
                ...
                if (i >= t) {
                    for (var s = o - Pf; s <= o + Pf || n > i; s++) {
                        ...
                        a.push("" + (s + 1) + jf(" ", 3 - String(s + 1).length) + "|  " + r[s]);
                        var l = r[s].length;
                        if (s === o) {
                            var u = t - (i - l) + 1;
                            var f = n > i ? l - u : n - t;
            ...
            return function n(r, i, a) {
                ...
                delete i.warn;
                {
                    try {
                        ...
                        if (e.toString().match(/unsafe-eval|CSP/)) {
                            o("It seems you are using the standalone build of Vue.js in an " + "environment with Content Security Policy that prohibits unsafe-eval. " + "The template compiler cannot work in this environment. Consider " + "relaxing the policy to allow unsafe-eval or pre-compiling your " + "templates into render functions.")
                        }
                    }
                }
                ...
                }));
                {
                    if ((!l.errors || !l.errors.length) && f.length) {
                        o("Failed to generate render function:\n\n" + f.map((function (e) {
                            var t = e.err;
                            var n = e.code;
            ...
            return function t(n) {
                function r(t, r) {
                    ...
                    if (r) {
                        ...
                        if (r.directives) {
                            i.directives = L(Object.create(n.directives || null), r.directives)
                        }
                        for (var u in r) {
        ...
        oi.prototype.$mount = function (e, t) {
            ...
            if (e === document.body || e === document.documentElement) {
                ge("Do not mount Vue to <html> or <body> - mount to normal elements instead.");
                return this
            }
            var n = this.$options;
            if (!n.render) {
                ...
                if (r) {
                    if (typeof r === "string") {
                        if (r.charAt(0) === "#") {
                            r = Gf(r);
                            if (!r) {
                                ge("Template element not found or is empty: " + n.template, this)
                            }
                        }
                    } else if (r.nodeType) {
                        r = r.innerHTML
    ...
    function I({siteKey: e, stoken: t, isEnterprise: n}) {
        var r = {
            anticaptcha: null,
            siteKey: e,
            representatives: [],
    ...
    function B(e, t, n) {
        ...
        var i;
        if (r.left < 0 || r.top < 0 || r.right >= H() || r.bottom >= U()) {
            i = true;
            var a = {
                display: "block",
                position: "fixed",
    ...
    function q(e, t, n) {
        ...
        for (var s = 0; s < r.length; s++) {
            o = r[s].nodeName.toLowerCase().replace(":", "\\:") + (t ? n && $.trim(r[s].id) && $.trim(r[s].id).length < 48 ? "#" + W($.trim(r[s].id)) : ":nth-child(" + (parseInt($(r[s]).index()) + 1) + ")" : "") + (n && $.trim(r[s].getAttribute("name")) && $.trim(r[s].getAttribute("name")).length < 48 ? '[name="' + W($.trim(r[s].getAttribute("name"))) + '"]' : "") + ($.trim(r[s].getAttribute("type")) ? '[type="' + $.trim(r[s].getAttribute("type")) + '"]' : "");
            a = o + (s != 0 ? " > " : " ") + a;
    ...
    function re(e, t = 27, n = 1e3) {
        return (n + Math.round(Math.random() * n) * 2 + (!e ? 1 : 0)).toString(t)
    }

    function ie({captchaType: e, errorCode: t = null, isCachedResult: n = true, jsonResult: r = {}}) {
    ...
    Vue.component("checkbox", {
        ...
        props: ["checked", "label", "title", "info", "additional_action", "additional_action_title", "additional_action_callback"],
        ...
        methods: {
            whereSolveSelectHandler(e) {
                ...
                if (e === "add") {
                    ...
                    if (typeof this.whereSolveList[this.currentWhatSolveIndex] !== "undefined") {
                ...
                this.currentWhatSolveIndex = this.whereSolveList.indexOf(this.hostname.trim())
            }
        },
        watch: {
            currentWhatSolveIndex() {
                ...
                document.getElementById("where_solve_list").selectedIndex = this.currentWhatSolveIndex
                ...
                if (typeof this.where_solve_list !== "undefined" && typeof this.whereSolveList === "undefined") {
    ...
    const fe = new Vue({
        ...
        methods: {
            applyApiKey(e) {
                ...
                chrome.extension.getBackgroundPage().saveOptions({account_key: this.accountKey}, (() => {
                ...
                this.statusMessageTimeout = setTimeout((() => this.statusMessage = null), 1e3)
            }, whyKeyToggle() {
                this.whyKeyBlockShow = !this.whyKeyBlockShow
            }, showErrorMessage(e) {
                if (e && e.trim()) {
                    ee("error", chrome.extension.getBackgroundPage().globalStatus)
                }
                this.errorMessage = e;
                this.balanceMessage = null
                ...
                if (chrome.extension.getBackgroundPage().globalStatus.profile_user_info) {
                    this.freeAttemptsMessage = chrome.i18n.getMessage("freeAttemptsLeft", e + "") + (!e ? chrome.i18n.getMessage("getAntiCaptchaKey") : "")
                } else {
                    if (e) {
                        this.freeAttemptsMessage = chrome.i18n.getMessage("getFreeAttempts", e + "")
                    } else {
                        this.freeAttemptsMessage = null
                    }
                }
                ...
                var e = ue(this.quickAddProxyInput);
                if (!e.protocol) {
                } else {
                ...
                chrome.runtime.onMessage.addListener(((e, t, n) => {
                    if (e.type === "showMessage") {
                        delete e.type;
                        if (e.method && e.method.match(/(show|refresh)[a-z]+Message/i) && typeof this[e.method] == "function") {
            ...
            globalStatus: {
                handler(e, t) {
                    if (typeof t.enable !== "undefined") {
                        chrome.extension.getBackgroundPage().saveOptions(this.globalStatus, (() => {
                            this.showStatusMessage(chrome.i18n.getMessage("optionsSaved"))
                        }), true)
                    }
                }, deep: true
                ...
                chrome.extension.getBackgroundPage().saveOptions({options_current_tab: this.currentTab}, (() => {
                }))
            }
        },
        updated() {
            ...
            if (document.getElementById("recaptcha_precache_debug_link")) {
                document.getElementById("recaptcha_precache_debug_link").href = chrome.extension.getURL("/recaptcha_precache_debug.html")
            }
        },
        mounted() {
    ...
    function ce(e) {
        if (chrome.extension.getBackgroundPage() == null) {
            chrome.extension.getBackgroundPage = function () {
                return {
                    globalStatus: e, getAndRefreshAntigateBalance: function () {
                        chrome.runtime.sendMessage({type: "getAndRefreshAntigateBalance"})
