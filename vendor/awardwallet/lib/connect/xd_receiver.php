...
<body>
	...
	<script src="/lib/connect/javascript/XdCommReceiver.js" type="text/javascript"></script>
...
<!--script>
var wind;
if(location.href.indexOf('fname=_parent') > 0)
	wind = window.parent;
else
	wind = window.opener;
if(location.href.indexOf('fbCancelLogin') > 0)
	wind.location.href = '/';
else
	wind.authComplete();
if(wind == window.opener)
	window.close();
</script-->
