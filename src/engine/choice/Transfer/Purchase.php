...
class Purchase extends \TAccountChecker
{
    ...
    public function purchaseMiles(array $fields, $numberOfMiles, $creditCard)
    {
        ...
        if ($numberOfMiles < 1000 || $numberOfMiles > 50000 || $numberOfMiles % 1000 !== 0) {
            throw new \UserInputError("Number of purchased points should be less than 50,000 and divisible by 1000");
        }
        $this->http->GetURL("https://storefront.points.com/choice-privileges/en-US/buy?product=BUY");
//        $this->http->GetURL("https://buy.points.com/PointsPartnerFrames/partners/choicehotels/container.html?product=BUY");
