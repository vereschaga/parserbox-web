var plugin = {
    ...
    hosts: {'secure.royalcaribbean.com': true, 'www.royalcaribbean.com': true},

    getStartingUrl: function (params) {
        return "https://www.royalcaribbean.com/account/signin?redirectUrl=%2F";
    },
    ...
    isLoggedIn: function () {
        ...
        if ($('.hero-header__loyalty-info-royal:visible').length > 0) {
    ...
    login: function (params) {
        ...
        if (form.length > 0) {
            ...
            provider.setNextStep('checkLoginErrors', function () {
                $('button[type="submit"]:contains("Sign in")').get(0).click();
                setTimeout(function () {
