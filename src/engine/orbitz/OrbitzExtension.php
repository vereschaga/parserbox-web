...
namespace AwardWallet\Engine\orbitz;
...
class OrbitzExtension extends AbstractParser implements LoginWithIdInterface
{
    public function getStartingUrl(AccountOptions $options): string
    {
        return 'https://www.orbitz.com/user/account?&langid=1033';
    }
