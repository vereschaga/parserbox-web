...
define("common/template/serviceError", [], (function () {
    ...
    return {
        changeScreenTitle: function (e, t) {
            e = e || "", [["<sup>®</sup>", "(R)"], [/&amp;/g, "&"], ["<sup>SM</sup>", "℠"]].forEach((function (t) {
                e = e.replace(t[0], t[1])
    ...
    return m(f, {
        isDefined: function (e) {
            ...
            if (null == e) t = "--"; else {
                if (0 === e) return 0;
                e > 0 ? t = this.convertToInt(this.convertToDecimal(e)) : e < 0 && (t = "–" + this.convertToInt(this.convertToDecimal(e)))
            }
            return t
    ...
    return {
        formatDateUtility: i, formatCurrencyUtility: (t = function (e, t, n, i, o, r, a) {
            ...
            formatCurrency: function (e, n, i, r, a, s) {
                ...
                var i = e;
                try {
                    t = o(t, "$"), n = o(n, ","), i = this.formatCurrency(this.stripCurrency(e), 2, n, "–", t)
                } catch (t) {
                    i = e
                }
                return i
    ...
    return {
        createDateObjArray: function (e, n, i) {
            ...
            a = void 0 !== a ? a : 2;
            var s = r("minusSymbol", "–"), c = r("commaSymbol", ","), l = r("currencyDollarSymbol", "$"), u = e;
            try {
