var plugin = {
    ...
    hosts : {
        'ffdt.loyaltyplus.aero' : true,
        'taag.com'              : true
    },

    getStartingUrl : function (params) {
        return 'http://ffdt.loyaltyplus.aero/loyalty/home.seam';
    },
    ...
    isSameAccount : function (account) {
        ...
        var accountNumber = util.findRegExp($('p:contains("Membership #:")', '#summary_left').text(), /Membership #:\s*([^<]+)/i);

        return (
            'undefined' != typeof account.properties
            && 'undefined' != typeof account.properties.Membership
            && '' != account.properties.Membership
            && accountNumber == account.properties.Membership
        );
    },
    ...
    logout : function () {
        ...
        provider.setNextStep('start', function () {
            document.location.href = 'http://ffdt.loyaltyplus.aero/loyalty/main.seam?actionOutcome=logoff';
        });
    },
