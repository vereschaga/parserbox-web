...
class StarbucksExtensionJapan extends AbstractParser implements LoginWithIdInterface, ParseInterface
{
    use TextTrait;
    ...
    {
        return "https://login.starbucks.co.jp/login";
    }
    ...
    public function login(Tab $tab, Credentials $credentials): LoginResult
    {
        ...
        $tab->evaluate('//button[contains(@class,"btn btnAction")]')->click();
