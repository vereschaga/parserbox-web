...
class It1964977 extends \TAccountCheckerExtended
{
    public $rePlain = "#\n[>\s*]*From\s*:[^\n]*?@alitalia[.]it#i";
    public $rePlainRange = "";
    public $reHtml = "";
    ...
    public $xPath = "";
    public $mailFiles = "alitalia/it-1964977.eml";
            ...
            "#.*?#" => [
                ...
                "#.*?#" => [
                    ...
                    "Status" => function ($text = '', $node = null, $it = null) {
                        $q1 = whiten('has been rescheduled');
                        $q2 = whiten('The flight is now expected');
                    ...
                    "TripSegments" => [
                        "FlightNumber" => function ($text = '', $node = null, $it = null) {
                            $fl = between('that flight', 'of');

                            return uberAir($fl);
                        },

                        "DepCode" => function ($text = '', $node = null, $it = null) {
                            $code = between('to leave', 'at');
                        ...
                        "DepDate" => function ($text = '', $node = null, $it = null) {
                            $pat = whiten('
								of (?P<date>\d+/\d+) has been rescheduled [.]
								.+?
								to leave .+? at (?P<time1>\d+:\d+)
								and arrive in .+? at (?P<time2>\d+:\d+) [.]
							');
