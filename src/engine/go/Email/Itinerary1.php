...
{
    public $mailFiles = "go/it-1.eml";
    public $processors = [];
    public $reFrom = "#customercare\@iflygo\.com#";
    public $reProvider = "#iflygo\.com#";
    public $reSubject = null;
    public $reText = "#Mahalo for choosing go#";
    public $reHtml = null;
    ...
    public function __construct()
    {
        ...
        $this->processors = [
            ...
            "#Mahalo for choosing#" => function (&$it, $parser) {
                ...
                $nodes = $this->http->XPath->query("//td[contains(text(), 'Flight')]/ancestor::table[3]/tr[2]//table[1]//tr");

                if ($nodes->length == 0) {
                    $nodes = $this->http->XPath->query("//td[contains(text(), 'Flight')]/ancestor::table[3]/tbody/tr[2]//table[1]//tr");
                }
