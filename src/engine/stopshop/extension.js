var plugin = {
    ...
    hosts: {
        'stopandshop.com': true,
        'www.stopandshop.com': true,
    },

    getStartingUrl: function (params) {
        return 'https://www.stopandshop.com/';
    },
    ...
    parse: function (params) {
        ...
        // https://stackoverflow.com/a/39812370
        $.ajax = (($oldAjax) => {
        ...
        $.ajax({
            type: 'GET',
            url: 'https://stopandshop.com/api/v1.0/current/user',
            async: false,
        ...
        $.ajax({
            type: 'GET',
            url: `https://stopandshop.com/api/v4.0/user/${userId}/profile`,
            async: false,
            ...
            success: function (response) {
                ...
                $.ajax({
                    type: 'GET',
                    url: 'https://stopandshop.com/apis/loyaltyaccount/v3/'+opco+'/' + cardNumber,
                    async: false,
                    beforeSend: function(request) {
                        request.setRequestHeader('Accept', 'application/json, text/plain, */*');
                        request.setRequestHeader('Cache-Control', 'no-cache');
        ...
        $.ajax({
            type: 'GET',
            url: 'https://stopandshop.com/apis/rewards/v1/preferences/'+opco+'/' + data.Number,
            async: false,
            beforeSend: function(request) {
                request.setRequestHeader('Accept', 'application/json, text/plain, */*');
                request.setRequestHeader('Cache-Control', 'no-cache');
        ...
        let url = 'https://stopandshop.com/apis/balances/program/v1/balances/' + data.Number + '?details=true&storeNumber=' + storeNumber;
        browserAPI.log(url);
        $.ajax({
            type: 'GET',
            url: url,
        ...
        $.ajax({
            type: 'GET',
            url: 'https://stopandshop.com/apis/aplus/v1/designated/schools/' + data.Number,
            async: false,
            beforeSend: function(request) {
                request.setRequestHeader('Accept', 'application/json, text/plain, */*');
                request.setRequestHeader('Cache-Control', 'no-cache');
            ...
            success: function (response) {
                ...
                for (const school in schools) {
                    ...
                    if (schools[school]) {
                        $.ajax({
                            type: 'GET',
                            url: 'https://stopandshop.com/apis/aplus/v1/school/details/' + schools[school],
                            async: false,
                            beforeSend: function(request) {
                                request.setRequestHeader('Accept', 'application/json, text/plain, */*');
                                request.setRequestHeader('Cache-Control', 'no-cache');
        ...
        $.ajax({
            type: 'GET',
            url: 'https://stopandshop.com/apis/balances/program/v1/gas/points/' + data.Number + '?details=true&storeNumber=' + storeNumber,
            async: false,
            beforeSend: function(request) {
                request.setRequestHeader('Accept', 'application/json, text/plain, */*');
                request.setRequestHeader('Cache-Control', 'no-cache');
            ...
            success: function (response) {
                ...
                if (typeof (response.gasPoints[0]) != 'undefined') {
