...
class It1729257 extends \TAccountCheckerExtended
{
    ...
    public $typesCount = "1";
    public $reFrom = "#travelteam@bcdtravel#i";
    public $reProvider = "";
    public $caseReference = "6734";
    public $xPath = "";
    public $mailFiles = "bcd/it-1729255.eml, bcd/it-1729257.eml";
            ...
            "#.*?#" => [
                ...
                "#.*?#" => [
                    ...
                    "ReservationDate" => function ($text = '', $node = null, $it = null) {
                        return totime(cell("Date of issue:", +1, 0));
                    },
                    ...
                    "TripSegments" => [
                        ...
                        "DepDate" => function ($text = '', $node = null, $it = null) {
                            ...
                            $anchor = totime(re("#Date of issue:\s*([^\n]+)#", $this->text()));
