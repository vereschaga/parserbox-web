...
{
    public $mailFiles = "aa/statements/it-95991452.eml, aa/statements/it-96613032.eml";
    ...
    private $detectBody = [
        'en' => [
            'This email confirms that your account has been updated as follows',
            'This email confirms that your request for donating miles has been received',
        ],
    ];

    public function detectEmailFromProvider($from)
    {
        $emails = ['american.airlines@info.email.aa.com'];
