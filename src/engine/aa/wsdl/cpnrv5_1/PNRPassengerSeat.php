...
class PNRPassengerSeat
{
     ...
     * @var string
     */
    public $SeatCharacteristicTypeDescription = null;

    /**
     * @var string
     */
    public $SeatCharacteristicPositionDescription = null;
     ...
     * @param string $SeatCharacteristicTypeDescription
     * @param string $SeatCharacteristicPositionDescription
     */
    public function __construct($PassengerSeatSequenceIdentifier, $SeatRowIdentifier, $RowLetterIdentifier, $FlightLegBeginDate, $FlightLegServiceEndCode, $FlightLegServiceBeginCode, $SeatFlightBooked, $SeatCharacteristicCode1, $SeatCharacteristicCode2, $ClassOfServiceBookedCode, $SeatSegmentStatusCurrentCode, $SeatSegmentStatusPreviousCode, $SeatCharacteristicTypeDescription, $SeatCharacteristicPositionDescription)
    {
        ...
        $this->SeatCharacteristicTypeDescription = $SeatCharacteristicTypeDescription;
        $this->SeatCharacteristicPositionDescription = $SeatCharacteristicPositionDescription;
    }
}
