...
class AAdvantageAccountEnrollment
{
     ...
     */
    public function __construct($LoyaltyAccountNumber, $LoyaltyProgramEnrollmentDate, $MergeStatusCode, $AccountStatusCode, $SecurityStatusCode, $LoyaltyAccountCommentCode, $LoyaltyAccountCommentExistsFlag, $MemberAccountMerger, $EliteStatus, $MemberMillionMileLevel, $MemberPartnerProgramProfile, $MemberActivitySummary, $MarketingSalesCityCode, $PartnerStratificationBenefits)
    {
